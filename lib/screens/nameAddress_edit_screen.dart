...
class _NameAddressEditScreenState extends State<NameAddressEditScreen> {
  ...
  void _saveForm(
    ...
    nameAddressProvider.addNewNameAddress(_editedNameAddress).then((_) {
      _isLoading = false;
    }).catchError((error) {
      setState(() {
        _isLoading = false;
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        onFieldSubmitted: (_) =>
                            _changeFocus(_middleNameFocusNode),
                        validator: (value) {
                          if (value.isEmpty) {
                      ...
                      TextFormField(
                        ...
                        focusNode: _middleNameFocusNode,
                        onFieldSubmitted: (_) =>
                            _changeFocus(_lastNameFocusNode),
                        validator: (value) {
                      ...
                      TextFormField(
                        ...
                        focusNode: _stateFocusNode,
                        onFieldSubmitted: (_) =>
                            _changeFocus(_landmarkFocusNode),
                        validator: (value) {
                          if (value.isEmpty) {
